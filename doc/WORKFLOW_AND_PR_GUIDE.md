...
- if the `sorry` substitutes the proof of a property tagged as `externally_verified`, the documentation must list the source of said external verification.
