...
| [`Spqr.lean`](./Spqr.lean) | Root Lean import file, regenerated by `lake exe mk_all`. |
...
| [`extraction-notes.md`](./extraction-notes.md) | Notes on which Rust modules extract cleanly and which required source modifications. |
